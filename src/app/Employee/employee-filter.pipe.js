...
var employeePipe = (function () {
    ...
    employeePipe.prototype.transform = function (input, searchText) {
        searchText = searchText ? searchText.toLocaleLowerCase() : null;
        return searchText ? input.filter(function (emp) {
            return (emp.FirstName + " " + emp.LastName).toLocaleLowerCase().indexOf(searchText) !== -1;
        }) : input;
    };
    return employeePipe;
}());
